...
if(isset($_POST['desc'])){
   ...
   $desc=$_POST['desc'];
    ...
    $res=AddNewPro($desc,$filename,$user_id);
    
    if(!empty($res)){
        $sucess="project inserted";
    }
    else{
        $error="oh no not inserted";
    }
...
<head>
  ...
  <!-- overlayScrollbars -->
  <link rel="stylesheet" href="pbackassets/lugins/overlayScrollbars/css/OverlayScrollbars.min.css">
  <!-- Daterange picker -->
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <?php if(isset($sucess) || isset($error)) : ?>
        <div class="alert <?php if(isset($error)):  ?> alert-danger<?php endif;?><?php if(isset($sucess)): ?> alert-success<?php endif;?> alert-dismissible">
                  <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                  <h5><i class="icon fas fa-ban"></i> Alert!</h5>
                  
                  <ul>
                    <li>
                    <?php  echo (isset($error))?$error:$sucess; ?>
              ...
              <form action="portfolio.php" method="post" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <textarea class="form-control textarea" name="desc" id="descr"></textarea>
                  </div>
